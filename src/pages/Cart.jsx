          ...
          <div className="w-[100%] md:w-[40%] mt-3  flex flex-col">
            ...
            <div className="flex flex-col ">
              <p className="text-xl font-bold"><span className="text-gray-700 font-semibold">Total Amount:</span> ${totalAmount}</p>
               ...
               {
                order ? ( <button onClick={orderplaced} className="bg-green-700 rounded-lg text-white transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold  p-3 text-xl">Place Order</button>)

                : ( <button onClick={cancel} className=" hover:bg-purple-50 rounded-lg transition duration-300 ease-linear mt-5 border-2 border-green-600 font-bold text-green-700 p-3 text-xl">Cancel Order</button>)
               }
